...
**Technologies:** Android, Node.js, Docker, AWS, DynamoDB, PostgreSQL, Arc GIS, Google Maps, Mapbox
...
## Experience
### Rooster Labs | Software Engineer <small>| Feb 2024 </small>
Creating tools to track personal finances, model finances and help people grow their nest egg. 

- Created a GIS tool to assess the real cost of buying a home in a new area using historical data
- Automated the analysis of data from various sources
- Provided interactive maps and reports to support decision-making processes.
